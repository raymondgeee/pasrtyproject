                        ...
                        if($queryCart AND $queryCart->num_rows > 0)
                        {
                            while ($resultCart = $queryCart->fetch_assoc()) 
                            {
                                ...
                                if($queryOrdered AND $queryOrdered->num_rows > 0)
                                {
                                    ...
                                    $categoryIdData = $resultOrdered['categoryId'];
                                }
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td class='w3-center'><i style='cursor:pointer;' data-cat='".$categoryId."' id='removeCart".$orderId."' data-id=".$orderId." class='w3-text-red fa fa-remove removeCart'></td>";
                                echo "</tr>";
                            }
                        }
                        else
